...
// Plantilla de invitación, parametrizada por los datos de una invitación
// (ver lib/invitation.js para la forma exacta del objeto). `watermark`
// controla si se muestra el pie "Hecho con..." del plan gratuito.
